...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/SetupBoard1.jpeg}
...
We can add an ssh key to the board, replacing PATH\_TO\_YOUR\_PUBKEY with a public key created by \verb+ssh-keygen+
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/SetupNetwork1.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/SetupNetwork2.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/confirmNetwork.jpeg}
